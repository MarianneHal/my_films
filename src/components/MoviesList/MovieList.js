        ...
        <div>
            ...
            <form onSubmit={handleSubmit(submit)}>
                ...
                <div className={css.genres}>
                    { toggle && genres.map(genre => <button className={css.btn_genre}
                        onClick={() => setQuery({
                            page: '1',
                ...
                {
                query.get('genre') ?
                    <h2>{(genres.find(value => value.id === parseInt(query.get('genre'))))?.name} genre</h2> :
                    <div></div>
            }
           <div className={css.movie}>
            ...
            <div className={css.pagination}>
                ...
                <button
                    onClick={toLast}><FontAwesomeIcon icon={faAngleDoubleRight}/></button>
            </div>
